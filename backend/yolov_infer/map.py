...
import numpy as np
import torch
from yolov_infer.models.common import DetectMultiBackend
from yolov_infer.utils.general import non_max_suppression
from yolov_infer.utils.torch_utils import select_device
